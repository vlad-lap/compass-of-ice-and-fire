...
import { MapSearchComponent, RouteControlComponent } from '../controls';
import { MapScaleComponent } from './scale/map-scale.component';
...
export class MapPageComponent {
    ...
    private readonly dragStickRadius = DRAG_STICK_RADIUS_PX;
